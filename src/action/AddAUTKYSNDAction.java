...
public class AddAUTKYSNDAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		String kYSND_SBET = "A";
		String kYSND_FORM = autKYSND.getkYSND_FORM();
		String kYSND_MKKG = "";
		...
		if(kYSND_BHNO!=null){
			if(kYSND_BHNO.length()<=14){
				autKYSND.setkYSND_BHNO1(kYSND_BHNO);
			}
				...
				kYSND_BHNO1 = kYSND_BHNO.substring(0,14);
				kYSND_FIL = kYSND_BHNO.substring(14, 15);
				kYSND_BHNO2 = kYSND_BHNO.substring(15, 26);
			}
		}
		else kYSND_BHNO = "";
		if(kYSND_MKCD!=null){
			...
			switch (kYSND_MKCD) {
			case "01":
				autKYSND.setkYSND_MKKG("H");
				break;
			case "02":
				autKYSND.setkYSND_MKKG("S");
				break;
			case "03":
				autKYSND.setkYSND_MKKG("Y");
				break;
			}
		}
		else {
